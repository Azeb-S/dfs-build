...
public class Build {
  ...
  public static String longestWord(Vertex<String> vertex, Set<Vertex<String>> visited) {
    ...
    for (Vertex<String> neighbor : vertex.neighbors) {
      String longestWordNeighbor = longestWord(neighbor, visited);
      if (longestWordNeighbor.length() > longest.length()) {
        longest = longestWordNeighbor;
      }
  ...
  public static <T> Set<T> unreachable(Map<T, List<T>> graph, T starting, Set<T> visited) {
